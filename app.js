...
function verificarIntento(){
   ...
   if(numeroDeUsuario === numeroSecreto){
    asignarTextoAElemento('p', `Correcto, acertaste el número en ${intentos} ${(intentos === 1) ? "intento" : "intentos"}!`);
    document.getElementById('reiniciar').removeAttribute('disabled');
    } else { 
        if(numeroDeUsuario > numeroSecreto){
            asignarTextoAElemento('p', "No acertaste, el número es menor al que indicaste");
        } else { 
            asignarTextoAElemento('p', "No acertaste, el número es mayor al que indicaste");
        }
        intentos++;
        limpiarCaja();
    }
...
/*
aber cómo usar funciones es uno de los conceptos fundamentales en la programación y el desarrollo de software. Las funciones desempeñan un papel crucial en la organización, modularización y reutilización del código.
